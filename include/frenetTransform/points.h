...
namespace FrenetTransform{
    ...
    public:
        ...
        /**
         * @brief Construct a new Points object from sequences of x- and y-coordinates.
         * The number of coordinates in both directions must be equal.
         *
         * @param x coordinates in x-direction of point sequence.
         * @param y coordinates in y-direction of point sequence.
         */
        Points(const ArrayPoints& x, const ArrayPoints& y)
            : m_x { x }, m_y { y }
        {
        }
         ...
         */
        ArrayPoints distanceSquare(const PointType& point) { return (m_x - point.x()).pow(2) + (m_y - point.y()).pow(2); }
         ...
         */
        ArrayPoints distance(const PointType& point) { return distanceSquare(point).sqrt(); }
         ...
         * @return Points<NumPoints, PointType> with sum of coordinates of "points1" and "points2".
         */
         ...
         * @return Points<NumPoints, PointType> with sum of coordinates in "point" and "points".
         */
         ...
         * @return Points<NumPoints, PointType> with difference between coordinates of "points1" and "points2".
         */
         ...
         * @return Points<NumPoints, PointType> with difference between coordinates in "points" and "point".
         */
         ...
         * @param point Point involved in the difference.
         * @param points Points involved in the difference.
         * @return Points<NumPoints, PointType> with difference between coordinates in "point" and "points".
         */
        friend Points<NumPoints, PointType> operator-(const PointType& point, const Points<NumPoints, PointType>& points) { return -points + point; }
         ...
         */
        friend ArrayPoints operator*(const Points<NumPoints, PointType>& points1, const Points<NumPoints, PointType>& points2) { return points1.m_x * points2.m_x + points1.m_y * points2.m_y; }
         ...
         */
        friend Points<NumPoints, PointType> operator*(const Points<NumPoints, PointType>& points, const ArrayPoints& nums) { return { points.m_x * nums, points.m_y * nums }; }
         ...
         * @return Points<NumPoints, PointType> products of "points" and "nums".
         */
        friend Points<NumPoints, PointType> operator*(const ArrayPoints& nums, const Points<NumPoints, PointType>& points) { return points * nums; }
